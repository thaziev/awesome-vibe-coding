...
- [NEDIO](https://marketplace.visualstudio.com/items?itemName=nedio.pomodoro-focus-music) - Pomodoro timer, focus music, and AI sprint reviews inside VS Code and Cursor.
